...
public class PrescriptionAdapterDoctor extends RecyclerView.Adapter<PrescriptionAdapterDoctor.MyViewHolder> {
    ...
    public PrescriptionAdapterDoctor(List<PrescriptionModel> lists) {
        this.list = lists;

    }

    public PrescriptionAdapterDoctor(List<PrescriptionModel> lists, prescriptionSelectListener lis) {
        this.list = lists;
        this.pListener = lis;
