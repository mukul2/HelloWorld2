...
import com.doctor.telemedicine.Utils.AudioPlayer;
...
public class VideoCallUIActivity extends VoiceCallBaseActivity {

    static final String TAG = VideoCallUIActivity.class.getSimpleName();
    ...
    private class UpdateCallDurationTask extends TimerTask {
        ...
        @Override
        public void run() {
            VideoCallUIActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    updateCallDuration();
                }
    ...
    private void addLocalView() {
        ...
        if (vc != null) {
            runOnUiThread(() -> {
                ...
                if (vc.getLocalView()!=null){
                    ((ViewGroup)vc.getLocalView().getParent()).removeView(vc.getLocalView()); // <- fix
                }
    ...
    private class SinchCallListener implements VideoCallListener {
        ...
        public void onCallEnded(Call call) {
            ...
            Toast.makeText(VideoCallUIActivity.this, endMsg, Toast.LENGTH_LONG).show();
