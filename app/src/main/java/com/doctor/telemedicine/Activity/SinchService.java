...
public class SinchService extends Service {
    ...
    private static final String APP_KEY = SinchCons.applicationKey;
    private static final String APP_SECRET = SinchCons.applicationSecret;
    private static final String ENVIRONMENT = SinchCons.environmentHost;
